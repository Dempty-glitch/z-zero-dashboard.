...
import { getSecureCardDetails } from '@/lib/provider';
...
export async function POST(request: Request) {
    try {
        ...
        // 2. Fetch Real Card Data from Issuer
        ...
        let realCardData;
        try {
            // 🚀 ISSUER ABSTRACTION: Fetch PAN securely from Provider (does not touch disk)
